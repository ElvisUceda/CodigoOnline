...
let ingreso = prompt(
  ...
  if (ingreso ==="lun" || ingreso=="LUN"){
    ...
    (ingreso ==="mar" || ingreso=="MAR"){
        console.log("El día es Martes");
  } else if
  (ingreso ==="mie" || ingreso=="MIE"){
    console.log("El día es Miercoles");
  } else if
  (ingreso ==="jue" || ingreso=="JUE"){
    console.log("El día es Jueves");
  } else if
  (ingreso ==="vie" || ingreso=="VIE"){
    console.log("El día es Viernes");
  } else if
  (ingreso ==="sab" || ingreso=="SAB"){
    console.log("El día es Sábado");
  } else if
  (ingreso ==="dom" || ingreso=="DOM"){
    console.log("El día es Domingo");
  } else {
  console.log("Usted a ingresado día incorecto");
}